...
const jumpFullscreenBtn = document.getElementById('jump-fullscreen-btn');
...
function updateFullscreenIcon() {
    ...
    if (document.fullscreenElement) {
        ...
        jumpFullscreenBtn?.classList.add('hidden');
    } else {
        icon.className = 'fas fa-expand';
        fullscreenBtn.title = 'Enter Fullscreen';
        jumpFullscreenBtn?.classList.remove('hidden');
    }
}
...
function setupEventListeners() {
    ...
    jumpFullscreenBtn?.addEventListener('click', enterFullscreen);
